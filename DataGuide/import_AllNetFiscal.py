...
dg_fs_IFRSC_2020_2021_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2020_2021.xlsx', sheet_name="IFRSC", header=None, skiprows=11, skipfooter=0)
dg_fs_IFRSC_2020_2021_data.to_pickle('./DataGuide_processed/dg_fs_IFRSC_2020_2021_data.pkl')

dg_fs_IFRSC_2020_2021_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2020_2021.xlsx', sheet_name="IFRSC", header=None, skiprows=7, nrows=4)
dg_fs_IFRSC_2020_2021_header.to_pickle('./DataGuide_processed/dg_fs_IFRSC_2020_2021_header.pkl')
...
dg_fs_IFRSC_2010_2019_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2010_2019.xlsx', sheet_name="IFRSC", header=None, skiprows=11, skipfooter=0)
dg_fs_IFRSC_2010_2019_data.to_pickle('./DataGuide_processed/dg_fs_IFRSC_2010_2019_data.pkl')

dg_fs_IFRSC_2010_2019_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2010_2019.xlsx', sheet_name="IFRSC", header=None, skiprows=7, nrows=4)
dg_fs_IFRSC_2010_2019_header.to_pickle('./DataGuide_processed/dg_fs_IFRSC_2010_2019_header.pkl')
...
dg_fs_IFRSC_2000_2009_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2000_2009.xlsx', sheet_name="IFRSC", header=None, skiprows=11, skipfooter=0)
dg_fs_IFRSC_2000_2009_data.to_pickle('./DataGuide_processed/dg_fs_IFRSC_2000_2009_data.pkl')

dg_fs_IFRSC_2000_2009_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2000_2009.xlsx', sheet_name="IFRSC", header=None, skiprows=7, nrows=4)
dg_fs_IFRSC_2000_2009_header.to_pickle('./DataGuide_processed/dg_fs_IFRSC_2000_2009_header.pkl')
...
dg_fs_GAAPC_2020_2021_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2020_2021.xlsx', sheet_name="GAAPC", header=None, skiprows=11, skipfooter=0)
dg_fs_GAAPC_2020_2021_data.to_pickle('./DataGuide_processed/dg_fs_GAAPC_2020_2021_data.pkl')

dg_fs_GAAPC_2020_2021_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2020_2021.xlsx', sheet_name="GAAPC", header=None, skiprows=7, nrows=4)
dg_fs_GAAPC_2020_2021_header.to_pickle('./DataGuide_processed/dg_fs_GAAPC_2020_2021_header.pkl')
...
dg_fs_GAAPC_2010_2019_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2010_2019.xlsx', sheet_name="GAAPC", header=None, skiprows=11, skipfooter=0)
dg_fs_GAAPC_2010_2019_data.to_pickle('./DataGuide_processed/dg_fs_GAAPC_2010_2019_data.pkl')

dg_fs_GAAPC_2010_2019_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2010_2019.xlsx', sheet_name="GAAPC", header=None, skiprows=7, nrows=4)
dg_fs_GAAPC_2010_2019_header.to_pickle('./DataGuide_processed/dg_fs_GAAPC_2010_2019_header.pkl')
...
dg_fs_GAAPC_2000_2009_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2000_2009.xlsx', sheet_name="GAAPC", header=None, skiprows=11, skipfooter=0)
dg_fs_GAAPC_2000_2009_data.to_pickle('./DataGuide_processed/dg_fs_GAAPC_2000_2009_data.pkl')

dg_fs_GAAPC_2000_2009_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2000_2009.xlsx', sheet_name="GAAPC", header=None, skiprows=7, nrows=4)
dg_fs_GAAPC_2000_2009_header.to_pickle('./DataGuide_processed/dg_fs_GAAPC_2000_2009_header.pkl')
...
dg_fs_GAAPN_2020_2021_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2020_2021.xlsx', sheet_name="GAAPN", header=None, skiprows=11, skipfooter=0)
dg_fs_GAAPN_2020_2021_data.to_pickle('./DataGuide_processed/dg_fs_GAAPN_2020_2021_data.pkl')

dg_fs_GAAPN_2020_2021_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2020_2021.xlsx', sheet_name="GAAPN", header=None, skiprows=7, nrows=4)
dg_fs_GAAPN_2020_2021_header.to_pickle('./DataGuide_processed/dg_fs_GAAPN_2020_2021_header.pkl')
...
dg_fs_GAAPN_2010_2019_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2010_2019.xlsx', sheet_name="GAAPN", header=None, skiprows=11, skipfooter=0)
dg_fs_GAAPN_2010_2019_data.to_pickle('./DataGuide_processed/dg_fs_GAAPN_2010_2019_data.pkl')

dg_fs_GAAPN_2010_2019_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2010_2019.xlsx', sheet_name="GAAPN", header=None, skiprows=7, nrows=4)
dg_fs_GAAPN_2010_2019_header.to_pickle('./DataGuide_processed/dg_fs_GAAPN_2010_2019_header.pkl')
...
dg_fs_GAAPN_2000_2009_data = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2000_2009.xlsx', sheet_name="GAAPN", header=None, skiprows=11, skipfooter=0)
dg_fs_GAAPN_2000_2009_data.to_pickle('./DataGuide_processed/dg_fs_GAAPN_2000_2009_data.pkl')

dg_fs_GAAPN_2000_2009_header = pd.read_excel(
    './DataGuide/DG_AllNetFiscal_2000_2009.xlsx', sheet_name="GAAPN", header=None, skiprows=7, nrows=4)
dg_fs_GAAPN_2000_2009_header.to_pickle('./DataGuide_processed/dg_fs_GAAPN_2000_2009_header.pkl')
