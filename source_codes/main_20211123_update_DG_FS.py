...
dg_fs_IFRSN_2020_2021_data = pd.read_excel(
    './data_raw/DG_AllNetFiscal_2020_2021_update.xlsx', sheet_name="IFRSN", header=None, skiprows=11, skipfooter=0)
dg_fs_IFRSN_2020_2021_data.to_pickle('./data_processed/dg_fs_IFRSN_2020_2021_update_data.pkl')
...
dg_fs_IFRSN_2000_2009_data = pd.read_pickle('./data_processed/dg_fs_IFRSN_2000_2009_data.pkl')
dg_fs_IFRSN_2010_2019_data = pd.read_pickle('./data_processed/dg_fs_IFRSN_2010_2019_data.pkl')
dg_fs_IFRSN_2020_2021_data = pd.read_pickle('./data_processed/dg_fs_IFRSN_2020_2021_update_data.pkl')

dg_fs_IFRSN_2000_2009_header = pd.read_pickle('./data_processed/dg_fs_IFRSN_2000_2009_header.pkl')
dg_fs_IFRSN_2010_2019_header = pd.read_pickle('./data_processed/dg_fs_IFRSN_2010_2019_header.pkl')
dg_fs_IFRSN_2020_2021_header = pd.read_pickle('./data_processed/dg_fs_IFRSN_2020_2021_update_header.pkl')
...
########################################################################################################################
# 데이터 저장하기
fs_IFRSN.to_pickle('./data_processed/fs_IFRSN.pkl')
