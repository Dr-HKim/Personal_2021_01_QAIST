...
fred_ISRATIO.to_pickle('./US_raw/fred_ISRATIO.pkl')
...
fred_PCEC96.to_pickle('./US_raw/fred_PCEC96.pkl')
...
fred_DPCERO1Q156NBEA.to_pickle('./US_raw/fred_DPCERO1Q156NBEA.pkl')

# 미국 산업 생산
# Industrial Production: Total Index (INDPRO)
# Units: Index 2017=100, Seasonally Adjusted
fred_INDPRO = fred.get_series('INDPRO')
fred_INDPRO.to_pickle('./US_raw/fred_INDPRO.pkl')
...
fred_XTEXVA01KRM667S.to_pickle('./US_raw/fred_XTEXVA01KRM667S.pkl')
